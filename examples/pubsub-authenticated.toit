...
/**
An example demonstrating how to subscribe and publish messages on
  a broker, connected through TLS.

This examples also demonstrates how to use MQTT username/password.

Be default uses test.mosquitto.org. This server is publicly accessible and
